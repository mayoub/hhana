...
L1_VARIABLES = {
    ...
    'l1tau1_emisol': {
        'title': r'L1 $\tau_1 EMISOL$',
        'root': 'L1 #font[152]{#tau}_{1} EMISOL',
        'filename': 'l1tau1_emisol',
        'binning': (20, 0., 20),
        'ypadding': (0.5, 0),
        'scale': 0.001,
        'units': 'GeV',
    ...
    'l1tau2_emisol': {
        'title': r'L1 $\tau_2 EMISOL$',
        'root': 'L1 #font[152]{#tau}_{2} EMISOL',
        'filename': 'l1tau2_emisol',
        'binning': (20, 0., 20),
        'ypadding': (0.5, 0),
        'scale': 0.001,
        'units': 'GeV',
    ...
    'dPhi_l1taus': {
        'title': r'$\Delta \phi(\tau,\tau)$',
        'root': 'L1 #font[152]{#Delta#phi}(#font[152]{#tau},#font[152]{#tau})',
        'filename': 'dphi_tau1_tau2',
        'binning': (12, 0., 3.4),
        'legend': 'left',
    },
